...
**Submission branch:** [zhouf/energy_forecast_fnn_model_v2](https://msdata.visualstudio.com/AlgorithmsAndDataScience/_git/TSPerf?version=GBhlu%2Fenergy_forecast_baseline_model)
...
In this submission, we implement a quantile regression feed forward neutral network model using the `qrnn` package in R or `keras` package in python .
...
1. Clone the TSPerf repo to the home directory of your machine and check out the baseline model branch
   ...
   git checkout zhouf/energy_forecast_fnn_model_v2
   ```
