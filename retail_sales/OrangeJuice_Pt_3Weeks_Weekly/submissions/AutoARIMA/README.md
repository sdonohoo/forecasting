...
**Pull request:** [Added Auto ARIMA method for retail sales forecasting](https://msdata.visualstudio.com/AlgorithmsAndDataScience/_git/TSPerf/pullrequest/150726?_a=overview)
...
7. Choose a name for a new Docker container (e.g. arima_container) and create it using command:   
   ...
   ```bash
   docker run -it -v ~/TSPerf:/TSPerf --name arima_container tsperf.azurecr.io/retail_sales/orangejuice_pt_3weeks_weekly/baseline_image:v1
   ```
...
**Cost:** The total cost is 2214.93/3600 $\times$ 0.768 = $0.4725.
