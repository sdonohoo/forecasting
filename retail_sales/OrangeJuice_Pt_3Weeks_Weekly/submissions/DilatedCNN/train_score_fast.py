...
# Data paths
DATA_DIR = './retail_sales/OrangeJuice_Pt_3Weeks_Weekly/data' #'../../data'
...
for r in range(12): #range(bs.NUM_ROUNDS):
    ...
    if r == 0:
        ...
        # Define checkpoint
        file_name = os.path.join('./retail_sales/OrangeJuice_Pt_3Weeks_Weekly/submissions/DilatedCNN', 'dcnn_model.h5')
